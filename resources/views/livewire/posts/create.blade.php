    ...
    <div class="w-11/12 lg:w-full md:w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden rounded-lg mb-12">
        ...
        <form method="POST" wire:submit.prevent="submit" enctype="multipart/form-data">
            ...
            <div>
                ...
                <select id="location" class="block mt-1 w-full" wire:model.lazy="location">
                    <option value="museum/sejarah">Museum Sejarah Kehidupan</option>
                    <option value="museum/bencana-geologi">Manfaat dan Bencana Geologi</option>
                    <option value="museum/sumber-daya-geologi">Sumber Daya Geologi</option>
                    <option value="museum/geologi-indonesia">Geologi Indonesia</option>
                </select>
            </div>
